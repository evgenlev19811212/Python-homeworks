# Документация проекта lesson_10
...
2. В отчете Allure вы увидите:
   ...
   - **Описание теста**: `Тест проверяет корректность работы магазина:авторизацию, выбор товаров и помещение их в корзину,заполнение личных данных и вывод общей стоимости покупки`.
   - **Шаги теста**.
